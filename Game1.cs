...
namespace Switcharoo
{
    public class Game1 : Game
    {
        ...
        // Load the monstrosity of assets
        ...
        // Main Update Method for Game Objects
        private void UpdateGame(GameTime gameTime)
        {
            ...
            if (!swapping && !waiting)
            {
                ...
                gameDone += (int)(gameTime.ElapsedGameTime.TotalMilliseconds);
        ...
        // Main Draw method for game objects
        ...
        private void DrawGameOver(GameTime gameTime)
        {
            ...
            else
            {
                ...
                Vector2 mes = gameOverFont.MeasureString("You lasted " + (int)(gameDone / 1000) + " seconds.");
                spriteBatch.DrawString(gameOverFont, ("You lasted " + (int)(gameDone / 1000) + " seconds."), new Vector2(WIDTH / 2 - mes.X / 2, 400), Color.Red);
                gameOverExit.Draw(gameTime, spriteBatch);
                gameOverMainMenu.Draw(gameTime, spriteBatch);
                gameOverPlayAgain.Draw(gameTime, spriteBatch);
                if (gameOverTimer <= FADE_DURATION * 2)
